...
const kafka = new Kafka({
  clientId: 'chart_2_consumer',
  brokers: ['kafka:9092'],
});

const consumer = kafka.consumer({ groupId: 'chart2cons' });
...
async function run() {
  ...
  await consumer.subscribe({ topic: 'chart_2', fromBeginning: true });
